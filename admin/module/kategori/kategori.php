                     ...
                     <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                                    ...
                                                    <td> 
                                                        <div class="button-group">
                                                           <a href="<?php echo  $admin_url; ?>adminweb.php?module=edit_kategori&id_kategori=<?php echo $kat['id_kategori']; ?>"
                                                            ...
                                                            <a href="<?php echo  $admin_url; ?>module/kategori/aksi_hapus_kategori.php?id_kategori=<?php echo$kat['id_kategori'] ; ?>"
                                       ...
                                       <div>
                                                <a href="adminweb.php?module=tambah_kategori"><button type="submit" class="btn btn-primary"><span><i class="fa fa-plus-circle"></i></span> Tambah Kategori</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
