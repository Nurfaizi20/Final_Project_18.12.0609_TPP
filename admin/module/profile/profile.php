            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="contact-form">
                        <center><h2>Data Profile</h2></center>>
                           <div class="status alert alert-success" style="display: none"></div>
                                  <?php
                                   if (isset($_GET['edit'])) {
                                  ?>
                            <form id="main-contact-form" action="adminweb.php?module=aksi_simpan" class="contact-form row" name="contact-form" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="user" value="<?= $u['id_user'] ?>">
                                 <div class="form-group col-md-12" align="center">
                                  <?php
                                    if (is_null($u['foto'])) {
                                     ?>
                                     <img src="upload/default.png" width="200" height="80" alt="..." class="img-thumbnail" style="">
                                     <?php
                                    }else { ?>
                                      <img src="upload/<?= $u['foto'] ?>" width="200" height="80" alt="..." class="img-thumbnail" style="">
                                      <?php
                                    }
                                    ?>
                        ...
                        ?>
                            <form id="main-contact-form" class="contact-form row" name="contact-form" method="GET">
                                ...
                                <div class="form-group col-md-12">
                                    <a class="btn btn-primary pull-right" href="adminweb.php?module=profile&edit">Edit</a>
                                </div>
                            </form>
                        <?php
                        }
