    ...
    if ($tipe_files=="image/jpeg" || $tipe_files=="image/png") {
            ...
            if ($ukuran_files <=1000000) {
                ...
                if (move_uploaded_file($tmp_files, $path)) {
                    ...
                    if ($simpan) {
                        echo "<script> alert('berhasil'); window.location = './adminweb.php?module=profile';</script>";
                        # code...
                    }else{
                        echo "<script> alert('gagal'); window.location = './adminweb.php?module=profile';</script>";
                    }
                }
            }
        }
